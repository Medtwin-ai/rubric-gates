...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{GPT-4 (OpenAI)}: Used as the agent in experimental 
    evaluation. Prompts and outputs are included in the supplementary material.
...
Agent prompts are available in the supplementary material repository.

\subsection{Compute Resources}

Experiments were run on AWS EC2 (c5.4xlarge) with:
\begin{itemize}[noitemsep]
    \item 16 vCPUs, 32 GB RAM
    \item DuckDB 0.9.2 for SQL execution
    \item Python 3.11 for analysis code
\end{itemize}

Total compute time: approximately 48 hours for full benchmark suite.
